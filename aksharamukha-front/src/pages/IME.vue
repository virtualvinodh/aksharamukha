<template>
  ...
  <q-page class="q-pa-md">
    ...
    <q-collapsible popup icon="keyboard" label="Keyboard Mapping" sublabel="">
      <div>
        <div class="row">
...
<script>
import {QTooltip, QEditor, QRadio, QBtn, QField, QBtnToggle, QToggle, QInput, QSelect, QOptionGroup, QAlert, QSpinnerComment, QCollapsible} from 'quasar'
...
export default {
  ...
  mounted () {
    if (localStorage.postOptions) {
      this.postOptions = localStorage.postOptions.split(',')
    }
  ...
  watch: {
    ...
    postOptions (newOpt, oldOpt) {
      localStorage.postOptions = newOpt
    },
